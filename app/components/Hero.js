...
export default function Hero() {
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
        <div className="order-2 lg:order-1 flex flex-col lg:flex-row items-center lg:items-start lg:gap-24 md:gap-12 gap-8">
          ...
          >
            {[
              { href: "https://www.linkedin.com/in/injamulhoque007/", icon: "linkedin", color: "hover:bg-blue-600 dark:hover:bg-blue-600" },
              { href: "https://github.com/injamul007", icon: "github", color: "hover:bg-slate-800 dark:hover:bg-white dark:hover:text-black" },
              { href: "https://x.com/InjamulHoq86366", icon: "twitter", color: "hover:bg-black dark:hover:bg-black" }
            ].map((social, index) => (
              <motion.div
                key={social.icon}
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-6">
            <motion.div className="space-y-2" variants={itemVariants}>
              ...
              <motion.div
                ...
                variants={itemVariants}
              >
                <span className="text-2xl lg:text-3xl font-semibold text-slate-700 dark:text-slate-200">I am a</span>
  ...
  transition-all duration-300 overflow-hidden"
                ...
                whileTap={{ scale: 0.98 }}
              >
                <span className="font-medium text-lg">Say Hello</span>
